...
def load_data():
    ...
    training_sequences = dataset["train"]["primary"]
    training_labels = dataset["train"]["log_fluorescence"]

    validation_sequences = dataset["validation"]["primary"]
    validation_labels = dataset["validation"]["log_fluorescence"]

    test_sequences = dataset["test"]["primary"]
    test_labels = dataset["test"]["log_fluorescence"]
...
def create_datasets(
    ...
    training_dataset = FluorescenceDataset(training_sequences, training_labels)
    validation_dataset = FluorescenceDataset(validation_sequences, validation_labels)
    test_dataset = FluorescenceDataset(test_sequences, test_labels)
