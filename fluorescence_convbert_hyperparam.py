...
def load_data():
    return load_embeddings_and_labels("./embeddings/p2s_fluorescence", "fluorescence")
...
def compute_objective(metrics):
    ...
    return metrics["eval_spearmanr"]


def main():
    model_type = "p2s"
    experiment = f"fluorescence_hyperparam_{model_type}"
