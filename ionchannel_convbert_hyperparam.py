...
def load_data():
    return load_embeddings_and_labels("./embeddings/p2s_ionchannels", "ionchannels")
...
def create_datasets(
    ...
    full_training_dataset = IonChannelDataset(
    ...
    test_dataset = IonChannelDataset(test_sequences, test_labels, label_encoder)
...
def main():
    model_type = "p2s"
    experiment = f"ionchannel_hyperparam_{model_type}"
